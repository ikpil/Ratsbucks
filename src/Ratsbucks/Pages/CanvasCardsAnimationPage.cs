...
public class CanvasCardsAnimationPageState
{
    public List<Card> Cards { get; set; } = Enumerable
        .Range(1, 10)
...
public class CanvasCardsAnimationPage : Component<CanvasCardsAnimationPageState>
{
