            ...
            ScrollView(
                VStack(
                        ...
                        Button("Click me!")
                            ...
                            .HCenter(),
                        Button("Toggle Theme", ApplicationTheme.ToggleCurrentAppTheme)
                            .HCenter()
                    )
                    .VCenter()
                    .Spacing(25)
        ...
        return Grid(
                ...
                Grid()
                    .Background(new LinearGradient(0,
                        (Theme.IsDarkTheme ? ApplicationTheme.DarkBackground : ApplicationTheme.LightBackground, 0.0f),
                        (Colors.Transparent, 0.2f),
                        (Colors.Transparent, 0.8f),
                        (Theme.IsDarkTheme ? ApplicationTheme.DarkBackground : ApplicationTheme.LightBackground, 1.0f))),
