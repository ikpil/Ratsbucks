...
public class AnimationShowcasePageState
{
...
public class AnimationShowcasePage : Component<AnimationShowcasePageState>
{
    public override VisualNode Render()
    {
        return ContentPage("Animation Showcase", Grid("Auto *", "*",
            Frame(
                VerticalStackLayout([
                        Button()
                        ...
                        HorizontalStackLayout([
                                ...
                                new Switch()
                                    ...
                                    .OnToggled((sender, args) =>
                                        SetState(s => s.IterationCount = args.Value ? null : 1, false)),
                            ])
                            .Spacing(5),
                        VerticalStackLayout([
                                ...
                                new Slider()
                                    ...
                                    .OnValueChanged((sender, args) =>
                                        SetState(s => s.InitialDelay = args.NewValue, false)),
                            ])
                            .Spacing(5),
                        VerticalStackLayout([
                                ...
                                new Picker()
                                    ...
                                    .OnSelectedIndexChanged((index) =>
                                        SetState(s => s.SelectedEasingIndex = index, false)),
                            ])
                            .Spacing(5),
                    ])
                    .Spacing(10)
                    ...
                    new SequenceAnimation
                        {
                            new DoubleAnimation()
                                ...
                                .Easing(() =>
                                    State.Easings[State.SelectedEasingIndex == -1 ? 0 : State.SelectedEasingIndex]
                                        .Easing)
