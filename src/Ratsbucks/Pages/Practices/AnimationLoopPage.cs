...
public class AnimationLoopPageState
{
...
public class AnimationLoopPage : Component<AnimationLoopPageState>
{
    private static readonly Color _baseColor = Color.Parse("#512BD4");
...
public class PlayControlsState
{
    public double PauseIconRotationAngle { get; set; }
}

public class PlayControls : Component<PlayControlsState>
{
    private static readonly PathF _pausePath = new PathF()
        .MoveTo(5, 2)
        .LineTo(5, 28)
        .MoveTo(18, 2)
        .LineTo(18, 28);

    private static readonly PathF _playPath = new PathF()
        .MoveTo(0, 0)
        .LineTo(0, 30)
        .LineTo(22, 15);
