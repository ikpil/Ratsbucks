...
public class CarouselTestPage : Component
{
...
public class CarouselTestPageWithImagesState
{
...
public class CarouselTestWithImagesPage : Component<CarouselTestPageWithImagesState>
{
    private MauiControls.CarouselView? _carouselView;
