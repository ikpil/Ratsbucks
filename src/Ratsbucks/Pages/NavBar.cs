...
partial class NavBar : Component<NavBarState>
{
    ...
    public override VisualNode Render()
    {
        return new CanvasView() //("59", "*")
                                ...
                                new Box
                                    {
                                        new Row()
                                        {
                                            ...
                                            new NavBarButtonIcon()
                                                .Icon("help_img.png")
                                                .IsSelected(State.SelectedItem == NavItem.Pay)
                                                .OnSelected(() => SetState(s => s.SelectedItem = NavItem.Pay)),
                                        }
                                    }
                                    .Padding(22, 7)
                            }
                ...
                .HeightRequest(59)
                .VEnd()
                .Shadow(Shadow().Brush(Colors.White).Opacity(0.2f).Radius(200).Offset(0.0, 10.0))
...
partial class NavBarButtonIcon : Component<NavBarButtonIconState>
{
    ...
    [Prop] private bool _isSelected;

    [Prop] private Action _onSelected;
