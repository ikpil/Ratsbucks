...
using Shadow = MauiReactor.Shadow;
...
partial class Login : Component<LoginState>
{
            ...
            Border()
                ...
                .Stroke(
                    new LinearGradientBrush(
                        ...
                        {
                            new GradientStop(Color.FromArgb("#C2CFF0").WithAlpha(0.55f), 0),
                            new GradientStop(Color.FromArgb("#98A4C1").WithAlpha(0.20f), 1),
                        })),
    ...
    void OnSignin()
    {
            ...
            string.IsNullOrWhiteSpace(State.Password))
        {
            ...
            Application.Current.Dispatcher.DispatchDelayed(TimeSpan.FromMilliseconds(2000),
                () => SetState(s =>
                {
        ...
        else
        {
            ...
            Application.Current.Dispatcher.DispatchDelayed(TimeSpan.FromMilliseconds(1000),
            () =>
            {
...
partial class LoginButton : Component<LoginButtonState>
{
    ...
    public override VisualNode Render()
    {
        ...
        .OnTapped(() =>
        {
            Application.Current.Dispatcher.DispatchDelayed(TimeSpan.FromMilliseconds(200), _onTapped);
