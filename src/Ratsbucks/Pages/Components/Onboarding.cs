...
class StartCourseButton : Component<StartCourseButtonState>
{
    ...
    public override VisualNode Render()
    {
        return new CanvasView()
        {
            new Align
            {
                new Group
                {
                        ...
                        new Box()
                            ...
                            .Background(
                                new LinearGradientBrush(
                                    ...
                                    {
                                        new GradientStop(Color.FromArgb("#F6AAA2"), 0.1535f),
                                        new GradientStop(Color.FromArgb("#FF557C"), 0.8795f),
                                    }))
                    }
                    .HStart()
                    .VStart()
                    ...
                    new Picture("Ratsbucks.Resources.Images.start_course_button.png")
                        .Margin(8,8,0,0),
        ...
        .OnTapped(() =>
        {
            ...
            Application.Current.Dispatcher.DispatchDelayed(TimeSpan.FromMilliseconds(800), _onTapped);
        })
        .Margin(40, 23)
        .HStart();
